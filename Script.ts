...
let arr: Array<string> = ["first","second","third"]; // define array like this also string[] both types are allowed.

// arr = [1,2,3]; // this will give error

let arrTupe:[string,number] = ["Uday",23]; // type here is necessory it should be of that type and the length should be fixed.
